...
const url ="[VELOCITYPRODUCTION]/x401_auth"
const path=new URL("[VELOCITYPRODUCTION]/x401_auth").pathname;
const challange_path="[VELOCITYPRODUCTION]/x401_web_auth_challange";
